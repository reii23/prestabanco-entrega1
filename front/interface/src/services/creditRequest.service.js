...
const API_URL = "prestabanco-app.brazilsouth.cloudapp.azure.com:8070/api/v1/CreditRequest/";
const LOAN_COST_API_URL = "prestabanco-app.brazilsouth.cloudapp.azure.com:8070/api/v1/loanCost/";

// get a client by rut to check if it exists
const getClientByRut = (rut) => {
    return axios.get(`prestabanco-app.brazilsouth.cloudapp.azure.com:8070/api/v1/clients/rut/${rut}`);
};
