...
const LOAN_COST_API_URL = "http://prestabanco-app.brazilsouth.cloudapp.azure.com:80/api/v1/loanCost/";

// get a client by rut to check if it exists
const getClientByRut = (rut) => {
    return axios.get(`http://prestabanco-app.brazilsouth.cloudapp.azure.com:80/api/v1/clients/rut/${rut}`);
};
